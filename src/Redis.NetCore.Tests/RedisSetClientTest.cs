    ...
    public class RedisSetClientTest
    {
        ...
        public async Task SetDifferenceAsync()
        {
            using (var client = TestClient.CreateClient())
            {
                ...
                await client.SetAddAsync(setKey1, "Foo".ToBytes(), "Bar".ToBytes(), "FooBar".ToBytes());
                await client.SetAddAsync(setKey2, "Bar".ToBytes());

                var bytes = await client.SetDifferenceAsync(setKey1, setKey2);
        ...
        public async Task SetIntersectionAsync()
        {
            using (var client = TestClient.CreateClient())
            {
                ...
                await client.SetAddAsync(setKey1, "Foo".ToBytes(), "Bar".ToBytes());
                await client.SetAddAsync(setKey2, "Bar".ToBytes(), "2".ToBytes());

                var bytes = await client.SetIntersectionAsync(setKey1, setKey2);
        ...
        public async Task SetUnionAsync()
        {
            using (var client = TestClient.CreateClient())
            {
                ...
                await client.SetAddAsync(setKey1, "Foo".ToBytes(), "Bar".ToBytes());
                await client.SetAddAsync(setKey2, "Bar".ToBytes(), "FooBar".ToBytes());

                var bytes = await client.SetUnionAsync(setKey1, setKey2);
